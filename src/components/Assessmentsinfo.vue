<template>
    <div class="space-y-8 text-white">
        <section
            class="flex flex-col md:flex-row gap-8 items-center bg-secondary p-10 max-w-6xl 2xl:max-w-none ml-auto rounded-l-2xl">
        ...
        <!-- Dyscalculia Section -->
        <section
            class="flex flex-col md:flex-row gap-8 items-center bg-secondary p-10 max-w-6xl 2xl:max-w-none mr-auto rounded-r-2xl">
            ...
            <div class="w-full md:w-2/3 space-y-4">
                ...
                <p>If you would like to know more about Dyslexia and Dyscalculia, you can find some information
                    <router-link class="underline" to="/dyslexia-and-dyscalculia">here</router-link>. Alternatively, I
                    am more than happy
                    to answer any specific questions if you drop me an email.
                </p>

                <a target="_blank" href="/T&C-Informal-Assessment.pdf" class="primary-button">
